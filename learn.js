...
// JavaScript Day 6
// Day 6 – String Practice (Advanced Edition)

// Q1. Capitalize first letter of each word in a sentence

let samllName = "aman";
let capName = samllName.charAt(0).toUpperCase() + samllName.slice(1);
console.log(capName);

// Q2. Capitalize Sentence with Function

function capSentence (parah) {
    let text = parah.split(" ");
    return text.map()
}